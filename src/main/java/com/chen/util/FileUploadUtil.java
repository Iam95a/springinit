...
public class FileUploadUtil {
	...
	public static final List<String> VIDEO_TYPES = Arrays.asList("video/mp4", "flv", "avi", "rm", "rmvb");
	...
	// 校验视频文件类型是否是被允许的
	public static boolean allowVideoUpload(String postfix) {
		return VIDEO_TYPES.contains(postfix);
	}
